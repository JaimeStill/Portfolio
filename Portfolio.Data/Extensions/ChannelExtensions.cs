...
namespace Portfolio.Data.Extensions
{
    public static class ChannelExtensions
    {
        ...
        public static async Task RemoveChannel(this AppDbContext db, Channel channel)
        {
        ...
        public static async Task RemoveChannelUser(this AppDbContext db, ChannelUser user)
        {
        ...
        public static async Task RemoveChannelMessage(this AppDbContext db, ChannelMessage message)
        {
